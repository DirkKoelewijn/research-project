...
Ethernet['next'] = Properties.HtonsProperty(Ethernet, "h_proto", 'next')
...
IPv4['len'] = Properties.HtonsProperty(IPv4, 'tot_len', 'len')
...
UDP['src'] = Properties.HtonsProperty(UDP, 'source', 'src')
UDP['dst'] = Properties.HtonsProperty(UDP, 'dest', 'dest')
UDP['len'] = Properties.HtonsProperty(UDP, 'len', 'len')
